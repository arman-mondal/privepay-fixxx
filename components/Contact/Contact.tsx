export default function Contact() {
    return (
      <section id="hero" className="relative min-h-[120vh] flex justify-center items-center">
        ...
        <div className="grid grid-cols-1 gap-12 mt-10 lg:grid-cols-2">
            ...
            <iframe src="https://maps.google.com/maps?q=20.000000,77.000000&z=5&output=embed" className="w-full h-96 rounded-lg" loading="lazy"></iframe>
                ...
                <div>
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">2nd floor, No 208, Girish Heights, Sadar, Near LIC Square, Civil Lines,Nagpur,Maharashtra,440001,India</p>
                </div>
                <div>
                    <span className="inline-block p-3 text-blue-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5">
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">info@privepay.in</p>
                </div>
                <div>
                    <span className="inline-block p-3 text-blue-500 rounded-full bg-blue-100/80 dark:bg-gray-800">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-5 h-5">
                    ...
                    <p className="mt-2 text-sm text-blue-500 dark:text-blue-400">+91 9960706662</p>
                </div>
            </div>
            ...
            <div className="p-4 py-6 rounded-lg bg-gray-50 dark:bg-gray-800 md:p-8">
                <form>
                    ...
                    <div className="mt-4">
                        ...
                        <input type="email" placeholder="Email address" className="block w-full px-5 py-2.5 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-lg dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" />
                    </div>
